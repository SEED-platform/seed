...
1. Github admin user, on develop branch: update the ``package.json`` and ``npm-shrinkwrap.json`` file with the most recent version number. Always use MAJOR.MINOR.RELEASE.
