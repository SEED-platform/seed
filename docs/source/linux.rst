...
.. code-block:: console
    ...
    DJANGO_SETTINGS_MODULE=config.settings.dev celery -A seed worker -l info -c 2 -B --events --max-tasks-per-child=1000 -B --scheduler django_celery_beat.schedulers:DatabaseScheduler
