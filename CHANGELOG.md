...
- Feature [#2760]( https://github.com/SEED-platform/seed/issues/2760 ), Derived Columns: allow derived column definitions and parameters to be used in multiple derived column definitions
...
- Fixed [#3067]( https://github.com/SEED-platform/seed/issues/3067 ), [03/31/22] SEED Version 2.14 – Compliance season release, SEED as a Platform improvements to support BEAM, Earth Advantage, OPEN, and others
...
- Fixed [#3118]( https://github.com/SEED-platform/seed/issues/3118 ), [4/15/2022] - Design for SEED UX for BPS.
...
- Fixed [#3160]( https://github.com/SEED-platform/seed/issues/3160 ), Update dependencies for march release
- Fixed [#3167]( https://github.com/SEED-platform/seed/issues/3167 ), BPS Design
...
- Fixed [#3200]( https://github.com/SEED-platform/seed/issues/3200 ), BuildingSync Asset Extractor Integration
...
- Fixed [#3209]( https://github.com/SEED-platform/seed/issues/3209 ), Add export functionality for dataloggers and sensors
- Feature [#3216]( https://github.com/SEED-platform/seed/issues/3216 ), Column Description Field
...
- Fixed [#3220]( https://github.com/SEED-platform/seed/issues/3220 ), Link ESPM + AT + CBL data
...
- Fixed [#3230]( https://github.com/SEED-platform/seed/issues/3230 ), Create sample org on seedv2
- Fixed [#3231]( https://github.com/SEED-platform/seed/issues/3231 ), format all python code using precommit
...
- Fixed [#3236]( https://github.com/SEED-platform/seed/issues/3236 ), Error trying to upload sensor data
- Fixed [#3242]( https://github.com/SEED-platform/seed/issues/3242 ), recreate BPS workflow in the BPS spec document
...
- Fixed [#3275]( https://github.com/SEED-platform/seed/issues/3275 ), readthedocs is not generating the same documentation as local builds of the documentation
- Fixed [#3276]( https://github.com/SEED-platform/seed/issues/3276 ), Roll-up / aggregation rough mockup and plan
...
- Feature [#3280]( https://github.com/SEED-platform/seed/issues/3280 ), Sensors: A few changes to Data Loggers section
...
- Fixed [#3307]( https://github.com/SEED-platform/seed/issues/3307 ), iframe configuration
- Fixed [#3308]( https://github.com/SEED-platform/seed/issues/3308 ), Add Audit Template Building ID to Audit Template Building Sync import
...
- Fixed [#3326]( https://github.com/SEED-platform/seed/issues/3326 ), Data Aggregation CRUD functionality
...
- Fixed [#3352]( https://github.com/SEED-platform/seed/issues/3352 ), Bump version of lxml to 4.9.1
