...
class SalesforceConfigSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'organization_id', 'indication_label', 'violation_label', 'compliance_label', 'account_rec_type', 'contact_rec_type',
                  ...
                  'account_name_column', 'data_admin_name_column', 'data_admin_email_column', 'data_admin_contact_fieldname', 'logging_email', 'benchmark_contact_fieldname', 'update_at_hour', 'update_at_minute')
