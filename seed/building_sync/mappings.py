...
BASE_MAPPING_V2_PR1 = {
    'property': {
        ...
        'properties': {
            'address_line_1': {
                'xpath': './auc:Address/auc:StreetAddressDetail/auc:Simplified/auc:StreetAddress',
                'type': 'value',
                'value': 'text',
                'required': True
            },
            'city': {
                'xpath': './auc:Address/auc:City',
                'type': 'value',
                'value': 'text',
                'required': True
            },
            'state': {
                'xpath': './auc:Address/auc:State',
                'type': 'value',
                'value': 'text',
                'required': True
            },
            'postal_code': {
                'xpath': './auc:Address/auc:PostalCode',
                'type': 'value',
                'value': 'text',
                'required': True
            },
