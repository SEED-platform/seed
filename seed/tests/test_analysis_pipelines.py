...
class TestEeejPipeline(TestCase):
    ...
    def test_get_data_for_census_tract_fetch(self):
        ...
        self.assertEqual(loc_data_by_property_view, {self.property_view.id: {'latitude': None, 'longitude': None, 'geocoding_confidence': None, 'tract': None, 'valid_coords': 0, 'location': '730 Garcia Street, Boring, Oregon, 97080'}})
