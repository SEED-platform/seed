...
class TestPropertyViewAsStateSerializers(DeleteModelsTestCase):
    def setUp(self):
        ...
        self.property_view = self.property_view_factory.get_property_view(state=self.property_state, cycle=self.cycle)
    ...
    def test_get_certifications(self):
        ...
        self.assertEqual(self.serializer.get_certifications(self.property_view), expected)
