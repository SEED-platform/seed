...
class PortfolioManagerReportParsingTest(TestCase):
    ...
    def test_hannah(self):
        pm = PortfolioManagerImport("DOE-BBC-UWHealth", "BBCDataAdmin!")
        property_ids = [5049100,4840467,4800631,5833568,5711425,5709627,5848152,5709927,5710550,5834442,5708944,5709021,4800738,4840525,5201317,5056463,5056462,5201313,5056456,4840513,10147125,4840612,4840316,4840326,4840913,4840917,5834458,5711302,5077360,5056467,5201245,6237747,5711309,5498195,5056460,5834384,4840920,5833692,4840925,4840986,4840945,4840907,5055994,5719295,10147131,4846625,4846623,5201307,4840934,5848958,4840957,5056465,4840958,4840962,4840964,5076252,5530945,6239474,5711295,4840565,4841012]
        pm.generate_and_download_meter_data(property_ids)
