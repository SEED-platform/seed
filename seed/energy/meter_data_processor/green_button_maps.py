...
reading_kind_map = {'0': 'none',                   # Not Applicable
                    ...
                    '148': 'tamper',
                    '149': 'watchdogTimeout',
                    # Customer's bill for the previous billing period
                    # (Currency)
                    '150': 'billLastPeriod',
                    # Customer's bill, as known thus far within the present
                    # billing period (Currency)
                    '151': 'billToDate',
...
uom_map = {'61': 'VA',         # Apparent power, Volt Ampere (See also real power and reactive power.), VA
           # Real power, Watt. By definition, one Watt equals one Joule per
           # second. Electrical power may have real and reactive components.
           # The real portion of electrical power (I2R) or VIcos, is expressed
           # in Watts. (See also apparent power and reactive power.), W
           '38': 'W',
           # Reactive power, Volt Ampere reactive. The "reactive" or
           # "imaginary" component of electrical power (VISin). (See also real
           # power and apparent power)., VAr
           '63': 'VAr',
           ...
           # Relative temperature in degrees Celsius. In the SI unit system the
           # symbol is oC. Electric charge is measured in coulomb that has the
           # unit symbol C. To distinguish degree Celsius from coulomb the
           # symbol used in the UML is degC. Reason for not using oC is the
           # special character o is difficult to manage in software.
           '23': 'degC',
           ...
           '3': 'g',         # Mass in gram, g
           # Pressure, Pascal (N/m2)(Note: the absolute or relative measurement
           # of pressure is implied with this entry. See below for more
           # explicit forms.), Pa
           '39': 'pa',
           '2': 'm',         # Length, meter, m
           ...
           # Sound pressure level, Bel, acoustic, Combine with multiplier
           # prefix "d" to form decibels of Sound Pressure Level"dB (SPL).", B
           # (SPL)
           '79': 'b',
           ...
           # Volume, cubic feet, ft3(compensated)
           '120': 'ft3compensated',
           # Volumetric flow rate, compensated cubic feet per hour,
           # ft3(compensated)/h
           '123': 'ft3compensatedPerH',
           # Turbine inertia, gram*meter2 (Combine with multiplier prefix "k"
           # to form kg*m2.), gm2
           '78': 'gM2',
           # Concentration, The ratio of the mass of a solute divided by the
           # mass of the solution., g/g
           '144': 'gPerG',
           ...
           # Density, gram/cubic meter (combine with prefix multiplier "k" to
           # form kg/ m3), g/m3
           '48': 'kgPerM3',
           '134': 'litre',         # Volume, litre = dm3 = m3/1000., L
           # Volume, litre, with the value compensated for weather effects,
           # L(compensated)
           '157': 'litreCompensated',
           # Volumetric flow rate, litres (compensated) per hour,
           # L(compensated)/h
           '138': 'litreCompensatedPerH',
           '137': 'litrePerH',         # Volumetric flow rate, litres per hour, L/h
           # Concentration, The ratio of the volume of a solute divided by the
           # volume of the solution., L/L
           '143': 'litrePerLitre',
           ...
           # Volumetric flow rate, litres (uncompensated) per hour,
           # L(uncompensated)/h
           ...
           # Volume, cubic meter, with the value compensated for weather
           # effects., m3(compensated)
           '167': 'm3compensated',
           # Volumetric flow rate, compensated cubic meters per hour,
           # 3(compensated)/h
           ...
           # m3uncompensated, cubic meter, with the value uncompensated for
           # weather effects., m3(uncompensated)
           '166': 'm3uncompensated',
           # Volumetric flow rate, uncompensated cubic meters per hour,
           # m3(uncompensated)/h
           '127': 'm3uncompensatedPerH',
           # EndDeviceEvent, value to be interpreted as a EndDeviceEventCode,
           # meCode
           '118': 'meCode',
           '7': 'mol',         # Amount of substance, mole, mol
           # Concentration, Molality, the amount of solute in moles and the
           # amount of solvent in kilograms., mol/kg
           '147': 'molPerKg',
           # Concentration, The amount of substance concentration, (c), the
           # amount of solvent in moles divided by the volume of solution in
           # m3., mol/ m3
           '145': 'molPerM3',
           # Concentration, Molar fraction (), the ratio of the molar amount of
           # a solute divided by the molar amount of the solution.,mol/mol
           '146': 'molPerMol',
           # Monetary unit, Generic money (Note: Specific monetary units are
           # identified the currency class).
           '80': 'money',
           ...
           # Time, Ratio of time (can be combined with an multiplier prefix to
           # show rates such as a clock drift rate, e.g. "us/s"), s/s
           '149': 'secPerSec',
