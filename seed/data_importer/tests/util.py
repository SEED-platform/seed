...
TAXLOT_MAPPING = [
    ...
    {'from_field': 'address', 'to_table_name': 'TaxLotState', 'to_field': 'address_line_1'},
    {'from_field': 'city', 'to_table_name': 'TaxLotState', 'to_field': 'city'},
    {'from_field': 'number_buildings', 'to_table_name': 'TaxLotState', 'to_field': 'number_properties'},
    {'from_field': 'block_number', 'to_table_name': 'TaxLotState', 'to_field': 'block_number'},
    {
...
PROPERTIES_MAPPING = [
    ...
    {'from_field': 'pm parent property id', 'to_table_name': 'PropertyState', 'to_field': 'pm_parent_property_id'},
    {'from_field': 'address line 1', 'to_table_name': 'PropertyState', 'to_field': 'address_line_1'},
    {'from_field': 'city', 'to_table_name': 'PropertyState', 'to_field': 'city'},
    {'from_field': 'property name', 'to_table_name': 'PropertyState', 'to_field': 'property_name'},
    {'from_field': 'property notes', 'to_table_name': 'PropertyState', 'to_field': 'property_notes'},
    {'from_field': 'use description', 'to_table_name': 'PropertyState', 'to_field': 'use_description'},
    {'from_field': 'gross floor area', 'to_table_name': 'PropertyState', 'to_field': 'gross_floor_area'},
    {'from_field': 'owner', 'to_table_name': 'PropertyState', 'to_field': 'owner'},
    {'from_field': 'owner email', 'to_table_name': 'PropertyState', 'to_field': 'owner_email'},
    {'from_field': 'owner telephone', 'to_table_name': 'PropertyState', 'to_field': 'owner_telephone'},
    {'from_field': 'site eui', 'to_table_name': 'PropertyState', 'to_field': 'site_eui'},
    {'from_field': 'energy score', 'to_table_name': 'PropertyState', 'to_field': 'energy_score'},
    {'from_field': 'year ending', 'to_table_name': 'PropertyState', 'to_field': 'year_ending'},
    {'from_field': 'extra data 1', 'to_table_name': 'PropertyState', 'to_field': 'data_007'},
    {'from_field': 'extra data 2', 'to_table_name': 'TaxLotState', 'to_field': 'data_008'},
    {'from_field': 'recent sale date', 'to_table_name': 'PropertyState', 'to_field': 'recent_sale_date'},
    {
        'from_field': 'postal code',
        'to_table_name': 'PropertyState',
        'to_field': 'postal_code',
