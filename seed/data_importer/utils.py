...
def kbtu_thermal_conversion_factors(country):
    ...
    if country == "US":
        ...
        factors['Coal (anthracite)']['Btu'] = .001
        ...
        factors['District Chilled Water - Absorption']['Btu'] = .001
        ...
        factors['District Chilled Water - Electric']['Btu'] = .001
        ...
        factors['District Chilled Water - Engine']['Btu'] = .001
        ...
        factors['District Chilled Water - Other']['Btu'] = .001
        ...
        factors['District Hot Water']['Btu'] = .001
        ...
        factors['District Steam']['Btu'] = .001
        ...
        factors['Electric - Grid']['Btu'] = .001
        factors['Electric - Grid']['kBtu (thousand Btu)'] = 1.00
        factors['Electric - Grid']['Wh (Watt-hours)'] = .00341
        ...
        factors['Electric - Solar']['Btu'] = .001
        factors['Electric - Solar']['kBtu (thousand Btu)'] = 1.00
        factors['Electric - Solar']['Wh (Watt-hours)'] = .00341
        ...
        factors['Electric - Wind']['Btu'] = .001
        factors['Electric - Wind']['kBtu (thousand Btu)'] = 1.00
        factors['Electric - Wind']['Wh (Watt-hours)'] = .00341
        ...
        factors['Fuel Oil (No. 5 and No. 6)']['Btu'] = .001
