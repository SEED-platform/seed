...
def pair_new_states(merged_property_views, merged_taxlot_views, sub_progress_key):
    ...
    tax_cmp_fmt = [
        ...
        # ('ulid',),  # How should this be updated to the related model Ubid? Taxlot.ubid_set.first().ubid
        ('custom_id_1',),
        ('normalized_address',),
        ('custom_id_1',),
    ]
    ...
    prop_cmp_fmt = [
        ...
        # ('ubid',),  # How should this be updated to the related model Ubid? Property.ubid_set.first().ubid
        ('custom_id_1',),
        ('normalized_address',),
        ('pm_property_id',),
