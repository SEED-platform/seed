...
from seed.data_importer.utils import kbtu_thermal_conversion_factors, usage_point_id, kgal_water_conversion_factor
...
class MetersParser:
    ...
    def _kgal_water_conversion_factors(self):
        if self._cache_kgal_water_conversion_factors is None:
            self._cache_kgal_water_conversion_factors = kgal_water_conversion_factor(self._org_country) 
