# -*- coding: utf-8 -*-
# Generated by Django 1.9.13 on 2017-09-07 15:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analysis_state', models.IntegerField(choices=[(1, 'Not Started'), (2, 'Started'), (3, 'Completed'), (4, 'Failed')], default=1)),
        ...
        migrations.AddField(
            model_name='propertystate',
            name='analysis_state',
            field=models.IntegerField(choices=[(1, 'Not Started'), (2, 'Started'), (3, 'Completed'), (4, 'Failed')], default=1),
        ),
        migrations.AddField(
            model_name='propertystate',
        ...
        migrations.AlterUniqueTogether(
            name='propertymeasure',
            unique_together=set([('property_state', 'measure', 'application_scale')]),
        ),
        migrations.AlterIndexTogether(
            name='propertymeasure',
