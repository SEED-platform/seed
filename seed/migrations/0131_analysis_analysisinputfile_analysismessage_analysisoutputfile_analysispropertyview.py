# Generated by Django 2.2.13 on 2020-11-23 20:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.IntegerField(choices=[(1, 'default')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('debug_message', models.CharField(default=None, max_length=255)),
                ('analysis_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seed.Analysis')),
                ('analysis_property_view_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seed.AnalysisPropertyView')),
            ],
        ),
        migrations.CreateModel(
