    ...
    operations = [
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            ...
                            (1, b'Portfolio Raw'),
                            (3, b'Portfolio'),
                            (4, b'BuildingSnapshot'),
                            (5, b'Green Button Raw'),
                        ]
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'match_type',
                    models.IntegerField(
                        blank=True, null=True, db_index=True, choices=[(1, b'System Match'), (2, b'User Match'), (3, b'Possible Match')]
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=models.deletion.CASCADE, related_name='+', blank=True, to='seed.BuildingSnapshot', null=True
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'canonical_snapshot',
                    models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, blank=True, to='seed.BuildingSnapshot', null=True),
                ),
            ],
            options={},
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'compliance_type',
                    models.CharField(
                        default=b'Benchmarking',
                        max_length=30,
                        verbose_name='compliance_type',
                        choices=[
                            (b'Benchmarking', 'Benchmarking'),
                            (b'Auditing', 'Auditing'),
                            (b'Retro Commissioning', 'Retro Commissioning'),
                        ],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'approver',
                    models.ForeignKey(
                        on_delete=models.deletion.CASCADE, verbose_name='User', blank=True, to=settings.AUTH_USER_MODEL, null=True
                    ),
                ),
                (
                    'building_snapshot',
                    models.ForeignKey(
                        on_delete=models.deletion.CASCADE, related_name='project_building_snapshots', to='seed.BuildingSnapshot'
                    ),
                ),
                (
                    'project',
                    models.ForeignKey(on_delete=models.deletion.CASCADE, related_name='project_building_snapshots', to='seed.Project'),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'organization',
                    models.ForeignKey(
                        on_delete=models.deletion.CASCADE, related_name='schemas', blank=True, to='orgs.Organization', null=True
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'meter',
                    models.ForeignKey(
                        on_delete=models.deletion.CASCADE, related_name='timeseries_data', blank=True, to='seed.Meter', null=True
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'unit_type',
                    models.IntegerField(
                        default=1, choices=[(1, b'String'), (2, b'Decimal'), (3, b'Float'), (4, b'Date'), (5, b'Datetime')]
                    ),
                ),
            ],
            options={},
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=models.deletion.CASCADE, related_name='last_modified_user', blank=True, to=settings.AUTH_USER_MODEL, null=True
            ),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=models.deletion.CASCADE, related_name='best_guess', blank=True, to='seed.CanonicalBuilding', null=True
            ),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=models.deletion.CASCADE, related_name='+', blank=True, to='data_importer.ImportRecord', null=True
            ),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='super_organization',
            field=models.ForeignKey(
                on_delete=models.deletion.CASCADE, related_name='building_snapshots', blank=True, to='orgs.Organization', null=True
            ),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=models.deletion.CASCADE, related_name='variants', blank=True, to='seed.BuildingSnapshot', null=True
            ),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=models.deletion.CASCADE, related_name='options', blank=True, to='seed.BuildingAttributeVariant', null=True
            ),
            preserve_default=True,
        ),
    ]
