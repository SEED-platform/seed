    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'parent_property',
                    models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='seed.Property'),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'taxlot',
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='views', to='seed.TaxLot'),
                ),
            ],
        ),
        migrations.AddField(
