...
def forwards(apps, schema_editor):
    ...
    Rule.objects.exclude(data_type=1).exclude(data_type=None).filter(min=None, max=None, not_null=True).update(condition='not_null')  # TODO: ?
    ...
    Rule.objects.filter(data_type=None, min=None, max=None, text_match=None, required=False, not_null=False).update(condition='')  # TODO: ?
