    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "record_type",
                    models.IntegerField(blank=True, choices=[(0, "ImportFile"), (1, "UserEdit"), (2, "UserCreate")], null=True),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="seed.GreenAssessmentProperty",
                    ),
                ),
                ("organization", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="orgs.Organization")),
                (
                ...
                (
                    "property_view",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, related_name="gapauditlog__view", to="seed.PropertyView"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "property_assessment",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="urls", to="seed.GreenAssessmentProperty"),
                ),
            ],
        ),
