    ...
    operations = [
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            ...
                            (17, 'Fenestration'),
                            (18, 'Foundation'),
                            (19, 'General Controls and Operations'),
                            (20, 'Critical IT System'),
                            (21, 'Plug Load'),
                            (22, 'Process Load'),
                            (23, 'Conveyance'),
                            (24, 'On-Site Storage, Transmission, Generation'),
                            (25, 'Pool'),
                            (26, 'Water Use'),
                            (27, 'Other'),
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'analysis_state',
                    models.IntegerField(choices=[(0, 'Not Started'), (1, 'Started'), (2, 'Completed'), (3, 'Failed')], default=0),
                ),
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='seed.PropertyState'
                    ),
                ),
                ...
                (
                    'scenario',
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, related_name='simulations', to='seed.Scenario'
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='meters', to='seed.PropertyView'
            ),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            ...
            name='organization',
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cycles', to='orgs.Organization'
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AddField(
            ...
            name='property_state',
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, related_name='building_files', to='seed.PropertyState'
            ),
        ),
        migrations.AddField(
            model_name='meter',
