...
def forwards(apps, schema_editor):
    ...
    for org in Organization.objects.all():
        if org.column_mappings.exists():
            ...
            org.columnmappingpreset_set.create(name=snapshot_mapping_name, mappings=snapshot_mappings(ColumnMapping, org))

        # Create PM mappings
        pm_mapping_name = 'Portfolio Manager Defaults'
        org.columnmappingpreset_set.create(name=pm_mapping_name, mappings=default_pm_mappings())
