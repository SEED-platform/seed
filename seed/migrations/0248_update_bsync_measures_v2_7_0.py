...
def populate_measures(apps, organization_id, schema_type="BuildingSync", schema_version="2.7.0"):
    """
    Populate the list of measures from BuildingSync version 2.7.0

    :param organization_id: integer, ID of the organization to populate measures
    :return:
    """
    filename = "seed/building_sync/enumerations/enumerations_v2_7_0.json"
...
def forwards(apps, schema_editor):
    # process the measures table with changes from BuildingSync v2.7.0
    ...
    for c in Organization.objects.all():
        ...
        populate_measures(apps, c.id, "BuildingSync", "2.7.0")
