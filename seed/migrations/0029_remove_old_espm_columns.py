...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # this was setup in the earlier migration:
        # 0025_add_espm_column_names.py
        bedes_schema, was_created = orm['seed.schema'].objects.get_or_create(
            name="BEDES"
        )

        bedes_schema.columns.all().delete()


    def backwards(self, orm):
        "This data migration does not support backwards migrations"
