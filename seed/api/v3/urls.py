...
from seed.views.v3.column_list_settings import ColumnListingViewSet
...
api_v3_router.register(r'column_list_settings', ColumnListingViewSet, base_name="column_list_settings")
