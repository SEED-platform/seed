...
class FakeDataReportFactory(BaseFake):
    ...
    def get_data_report(
        ...
        name = name or f"Data Report {report_type} {self.fake.random.randint(1, 100)}"
...
class FakeGoalFactory(BaseFake):
    ...
    def get_goal(
        ...
        goal_type = goal_type if goal_type else self.goal_type
