...
class DjangoFunctionalFactory:
    ...
    def rand_street_address(cls):
        s = f'{cls.rand_int(end=10000)} {cls.rand_plant_name()} {cls.rand_street_suffix()}'
        return s[:63]

    @classmethod
    def rand_city(cls):
        return f'{cls.rand_plant_name()}{cls.rand_city_suffix()}'
    ...
    @classmethod
    def rand_email(cls):
        return f'{cls.rand_name().lower()}@{cls.rand_domain()}'
