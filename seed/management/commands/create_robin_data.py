...
def create_cases(org, tax_lots, properties):
    ...
    for (tl_def, prop_def) in itertools.product(tax_lots, properties):
        ...
        tax_extra_data = tax_lot_extra_data_map[tl_def["jurisdiction_tax_lot_id"]]
        prop_extra_data = property_extra_data_map[prop_def["pm_property_id"]]
        ...
        taxlot_view, _ = seed.models.TaxLotView.objects.get_or_create(taxlot=taxlot, cycle=cycle,
                                                                      state=taxlot_state)
        prop_view, _ = seed.models.PropertyView.objects.get_or_create(property=property,
                                                                      cycle=cycle, state=prop_state)

        seed.models.TaxLotProperty.objects.get_or_create(property_view=prop_view,
                                                         taxlot_view=taxlot_view, cycle=cycle)
    ...
    tax_lots = [
        {
            ...
            "address_line_1": "050 Willow Ave SE",
            "city": "Rust",
            "number_properties": 1
        }
    ]
...
def create_case_B_objects(org):
    tax_lots = [
        {"jurisdiction_tax_lot_id": "11160509",
...
def create_case_C_objects(org):
    tax_lots = [
        {
            "jurisdiction_tax_lot_id": "33366555",
            "address_line_1": "521 Elm Street",
            "city": "Rust"
        },
        {
            "jurisdiction_tax_lot_id": "33366125",
            "address_line_1": "525 Elm Street",
            "city": "Rust"
        },
        {
            "jurisdiction_tax_lot_id": "33366148",
            "address_line_1": "530 Elm Street",
            "city": "Rust"
        }
    ]
...
def create_case_D_objects(org):
    tax_lots = [
        {
            "jurisdiction_tax_lot_id": "24651456",
            "address_line_1": "11 Ninth Street",
            "city": "Rust",
            "number_properties": 5
        }, {
            "jurisdiction_tax_lot_id": "13334485",
            "address_line_1": "93029 Wellington Blvd",
            "city": "Rust",
            "number_properties": None,
        }, {
            "jurisdiction_tax_lot_id": "23810533",
            "address_line_1": "94000 Wellington Blvd",
            "city": "Rust",
            "number_properties": None,
        }
    ]
    ...
    property_objs = [seed.models.Property.objects.get_or_create(organization=org,
                                                                parent_property=campus_property)[0]
                     for p in properties]
    ...
    property_states = [seed.models.PropertyState.objects.get_or_create(**prop_def)[0] for prop_def
                       in itertools.chain(campus, properties)]
    ...
    taxlot_states = [seed.models.TaxLotState.objects.get_or_create(**lot_def)[0] for lot_def in
                     tax_lots]
