...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--count', default=500, type=int, help='Number of rows to create', dest='count')

        parser.add_argument('--savefile', default='autogenerated_data.csv', help='Path where to save file', action='store', dest='savefile')
    ...
    def handle(self, *args, **options):
        ...
        with open(options['savefile'], mode='w', encoding=locale.getpreferredencoding(False)) as f:
            ...
            for i in range(options['count']):
                _, data = data_faker.create_sample_data(i)
