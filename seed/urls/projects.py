...
# from seed.views.projects import (
    # add_buildings_to_project, create_project, delete_project,
    # get_adding_buildings_to_project_status_percentage, get_project, get_projects,
    # get_projects_count, move_buildings, remove_buildings_from_project, update_project,
