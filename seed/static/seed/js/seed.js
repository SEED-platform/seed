    ...
    stateHelperProvider
      ...
      .state({
        ...
        resolve: {
          ...
          compliance_metrics: [
            ...
            function ($stateParams, compliance_metric_service) {
          ...
          property_columns: [
            ...
            'inventory_service',
            'naturalSort',
            function (valid_column_data_types, $stateParams, inventory_service, naturalSort) {
          ...
          x_axis_columns: [
            ...
            'inventory_service',
            'naturalSort',
            function (valid_x_axis_data_types, $stateParams, inventory_service, naturalSort) {
              return inventory_service.get_property_columns_for_org($stateParams.organization_id).then(function (columns) {
                columns = _.reject(columns, (item) => {
          ...
          auth_payload: [
            ...
            '$q',
            function (auth_service, $stateParams, $q) {
              return auth_service.is_authorized($stateParams.organization_id, ['requires_member']).then(
                function (data) {
                  if (data.auth.requires_member) {
                    return data;
                  } else {
      ...
      .state({
        ...
        resolve: {
          ...
          compliance_metrics: [
            'compliance_metric_service',
            function (compliance_metric_service) {
