 ...
 *
 */
angular.module('BE.seed.controller.property_update_labels_modal_ctrl', [])
.controller('property_update_labels_modal_ctrl', [
  ...
  'property',
  'Notification',
  function ($scope, $uibModalInstance, label_service, property, notification) {

    //Controller for the Update Property Labels modal window.
    //Manages applying labels to a single properties, as
    ...
    var init = function() {
        ...
        $scope.loading = true;
        label_service.get_labels([property.pk], false, {}).then(function(data){
