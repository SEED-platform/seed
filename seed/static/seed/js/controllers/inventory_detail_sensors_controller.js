    ...
    const base_sensor_col_defs = [
      ...
      },
      {
        ...
        cellTemplate:
          ...
          '<button type="button" class="btn-primary" style="border-radius: 4px;" ng-click="grid.appScope.open_sensor_update_modal(row.entity)"><i class="fa-solid fa-pencil"></i></button>' +
