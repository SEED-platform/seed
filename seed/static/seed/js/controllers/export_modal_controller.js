...
.controller('export_modal_controller', [
  ...
  'export_service',
  '$timeout',
  function ($scope, $log, $uibModalInstance, search, selected_fields, project, export_service, $timeout) {
    ...
    $scope.monitor_progress = function (export_id, total_buildings) {
      $scope.stop = $timeout(function () {
        export_service.export_buildings_progress(export_id).then(function (data) {
          // update progress bar
    ...
    $scope.show_success_page = function (export_id) {
      $scope.stop = $timeout(function () {
        export_service.export_buildings_download(export_id).then(function (data) {
