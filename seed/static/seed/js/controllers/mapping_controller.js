  ...
  function (
    ...
    var display_cached_column_mappings = function () {
      ...
      _.forEach($scope.mappings, function (col) {
        ...
        var mappable_column = _.find($scope.mappable_property_columns.concat($scope.mappable_taxlot_columns), { column_name: cached_col.to_field, table_name: cached_col.to_table_name });
        if (mappable_column) {
