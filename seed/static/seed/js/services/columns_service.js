...
angular.module('BE.seed.service.columns', []).factory('columns_service', [
  ...
  function ($http, user_service) {
    ...
    columns_service.create_column_for_org = (org_id, data) =>
      $http
        .post('/api/v3/columns/', {
    ...
    columns_service.update_column_for_org = (org_id, column_id, data) =>
      $http
    ...
    columns_service.rename_column = (column_id, column_name, overwrite_preference) =>
      columns_service.rename_column_for_org(user_service.get_organization().id, column_id, column_name, overwrite_preference);

    columns_service.rename_column_for_org = (org_id, column_id, column_name, overwrite_preference) =>
      $http
    ...
    columns_service.delete_column_for_org = (org_id, column_id) =>
      $http.delete(`/api/v3/columns/${column_id}/`, {
