...
angular.module('BE.seed.service.data_view', []).factory('data_view_service', [
  ...
  function ($http, $log, user_service) {
    ...
    const create_data_view = (name, filter_groups, cycles, data_aggregations) =>
      $http
        .post(
          '/api/v3/data_views/',
          {
    ...
    const update_data_view = (id, name, filter_groups, cycles, data_aggregations) =>
      $http
        .put(
    ...
    const evaluate_data_view = (data_view_id, columns) =>
      $http
        .put(
