...
angular.module('BE.seed.service.dataset', []).factory('dataset_service', [
  ...
  function ($http, user_service) {
    ...
    dataset_service.get_datasets_count = () =>
      $http
    ...
    dataset_service.get_dataset = (dataset_id) =>
      $http
    ...
    dataset_service.get_import_file = (import_file_id) =>
      $http
    ...
    dataset_service.check_meters_tab_exists = (file_id) =>
      $http
    ...
    dataset_service.reuse_inventory_file_for_meters = (file_id) =>
      $http
