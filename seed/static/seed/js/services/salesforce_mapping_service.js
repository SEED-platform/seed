...
angular.module('BE.seed.service.salesforce_mapping', []).factory('salesforce_mapping_service', [
  ...
  function ($http, $log) {
    ...
    const get_salesforce_mappings = (organization_id) =>
      $http
    ...
    const get_salesforce_mapping = (organization_id, id) =>
      $http
    ...
    // update
    const update_salesforce_mapping = (organization_id, id, data) =>
      $http
    ...
    // create
    const new_salesforce_mapping = (organization_id, data) =>
      $http
