angular.module('BE.seed.service.salesforce_config', []).factory('salesforce_config_service', [
  ...
  function ($http, $log) {
    ...
    const get_salesforce_config = (organization_id, id) => $http
    ...
    // delete
    const delete_salesforce_config = (organization_id, id) => {
      if (_.isNil(id)) {
    ...
    // update
    const update_salesforce_config = (organization_id, id, data, timezone = null) => $http
    ...
    // create
    const new_salesforce_config = (organization_id, data, timezone = null) => $http
     ...
     */
    const salesforce_connection = (organization_id, conf) => $http
      .post(
