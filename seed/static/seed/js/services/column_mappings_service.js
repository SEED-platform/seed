...
angular.module('BE.seed.service.column_mappings', []).factory('column_mappings_service', [
  ...
  function ($http, user_service) {
    ...
    column_mappings_factory.new_column_mapping_profile_for_org = (org_id, data) =>
      $http
    ...
    column_mappings_factory.get_header_suggestions_for_org = (org_id, headers) =>
      $http
        .post(
    ...
    column_mappings_factory.update_column_mapping_profile = (org_id, id, data) =>
      $http
    ...
    column_mappings_factory.delete_column_mapping_profile = (org_id, id) =>
      $http
     ...
     */
    column_mappings_factory.export_mapping_profile = (org_id, profile_id) =>
      $http.get(`/api/v3/column_mapping_profiles/${profile_id}/csv/?organization_id=${org_id}`).then((response) => response.data);
