...
angular.module('BE.seed.service.mapping', []).factory('mapping_service', [
  ...
  function ($http, user_service) {
     ...
     *  }
     */
    mapping_factory.get_column_mapping_suggestions = (import_file_id) =>
      $http
    ...
    mapping_factory.get_raw_columns = (import_file_id) =>
      $http
    ...
    mapping_factory.get_first_five_rows = (import_file_id) =>
      $http
     ...
     */
    mapping_factory.start_mapping = (import_file_id) =>
      $http
        .post(
     ...
     * @param import_file_id: int, represents file import id.
     */
    mapping_factory.remap_buildings = (import_file_id) =>
      $http
        .post(
          `/api/v3/import_files/${import_file_id}/map/`,
          {
