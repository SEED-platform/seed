...
from seed.models import Analysis, AnalysisMessage, AnalysisPropertyView, Column, Meter, MeterReading, PropertyView
...
def _run_analysis(self, meter_readings_by_analysis_property_view, analysis_id):
    ...
    column_meta = [
        {'column_name': 'analysis_co2', 'display_name': 'Average Annual CO2 (kgCO2e)', 'description': 'Average Annual CO2 (kgCO2e)'},
        {
    ...
    for analysis_property_view in analysis_property_views:
        ...
        analysis_property_view.parsed_results = {
            ...
            'Total GHG Emissions Intensity (kgCO2e/ft\u00b2/year)': co2['average_annual_kgco2e']
