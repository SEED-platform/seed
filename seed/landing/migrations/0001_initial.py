        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'username',
                    models.EmailField(
                        help_text="User's email address.  Used for auth as well.",
                        unique=True,
                        max_length=75,
                ...
                (
                    ...
                    models.BooleanField(default=False, help_text='shows shared buildings within search results', verbose_name='active'),
                ),
                ('api_key', models.CharField(default=b'', max_length=128, verbose_name='api key', db_index=True, blank=True)),
                (
                    'default_organization',
                    models.ForeignKey(
                        on_delete=models.deletion.CASCADE, related_name='default_users', blank=True, to='orgs.Organization', null=True
                    ),
                ),
                (
                    'groups',
