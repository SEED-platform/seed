...
class TestOrganizations(TestCase):
    ...
    def test_suborgs_parent(self):
        user_details_2 = {'username': 'test_user_2@demo.com', 'password': 'test_pass', 'email': 'test_user_2@demo.com'}
        user2 = User.objects.create(**user_details_2)

        created, suborg, org_user = create_suborganization(user2, self.fake_org, 'sub org name', ROLE_VIEWER)
