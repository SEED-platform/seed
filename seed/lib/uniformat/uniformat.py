...
uniformat_data: list[UniformatEntry] = [
    ...
    {'code': 'B301090', 'category': 'OTHER ROOFING', 'definition': 'Roofing not described by the assembly categories listed above.'},
    {
        'code': 'C',
        'category': 'INTERIOR',
    ...
    {'code': 'C302005', 'category': 'CARPETING', 'imperial_units': 'SF', 'metric_units': 'M2', 'quantity_definition': 'Area of carpeting'},
    {
        'code': 'C302006',
    ...
    {'code': 'D102003', 'category': 'MONORAILS', 'imperial_units': 'EA', 'metric_units': 'EA', 'quantity_definition': 'Number of items'},
    {
        'code': 'D1030',
    ...
    {'code': 'D103001', 'category': 'ESCALATORS', 'imperial_units': 'LF', 'metric_units': 'M', 'quantity_definition': 'Length of stairs'},
    {'code': 'D103002', 'category': 'MOVING WALKS', 'imperial_units': 'LF', 'metric_units': 'M', 'quantity_definition': 'Length of walks'},
    {
        'code': 'D103090',
    ...
    {'code': 'D201002', 'category': 'URINALS', 'imperial_units': 'EA', 'metric_units': 'EA', 'quantity_definition': 'Number of fixtures'},
    {
        'code': 'D201003',
        'category': 'LAVATORIES',
        'imperial_units': 'EA',
    ...
    {'code': 'D201004', 'category': 'SINKS', 'imperial_units': 'EA', 'metric_units': 'EA', 'quantity_definition': 'Number of fixtures'},
    {
        'code': 'D201005',
    ...
    {'code': 'D201007', 'category': 'BIDETS', 'imperial_units': 'EA', 'metric_units': 'EA', 'quantity_definition': 'Number of fixtures'},
    {
        'code': 'D201090',
    ...
    {'code': 'D402002', 'category': 'FIRE PUMP', 'imperial_units': 'EA', 'metric_units': 'EA', 'quantity_definition': 'Number of pumps'},
    {
        'code': 'D4030',
    ...
    {'code': 'F101090', 'category': 'OTHER SPECIAL CONSTRUCTION'},
    {
        'code': 'F1020',
    ...
    {'code': 'F104005', 'category': 'ICE RINKS', 'imperial_units': 'SF', 'metric_units': 'M2', 'quantity_definition': 'Area of ice rink'},
    {
        'code': 'F104090',
    ...
    {'code': 'F201001', 'category': 'SUBSTRUCTURE & SUPERSTRUCTURE', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F201002', 'category': 'EXTERIOR CLOSURE', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F201003', 'category': 'ROOFING', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F201004', 'category': 'INTERIOR CONSTRUCTION & FINISHES', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F201005', 'category': 'CONVEYING SYSTEMS', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F201006', 'category': 'MECHANICAL SYSTEMS', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F201007', 'category': 'ELECTRICAL SYSTEMS', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F201008', 'category': 'EQUIPMENT & FURNISHINGS', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {
        'code': 'F201090',
    ...
    {'code': 'F202001', 'category': 'SUBSTRUCTURE & SUPERSTRUCTURE', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F202002', 'category': 'EXTERIOR CLOSURE', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F202003', 'category': 'ROOFING', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F202004', 'category': 'INTERIOR CONSTRUCTION & FINISHES', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F202005', 'category': 'CONVEYING SYSTEMS', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F202006', 'category': 'MECHANICAL SYSTEMS', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F202007', 'category': 'ELECTRICAL SYSTEMS', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'F202008', 'category': 'EQUIPMENT & FURNISHINGS', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {
        'code': 'F202090',
    ...
    {'code': 'G201090', 'category': 'OTHER ROADWAYS', 'definition': 'Roadways not described by the assembly categories listed above.'},
    {
        'code': 'G2020',
    ...
    {'code': 'G206002', 'category': 'OTHER PAVING', 'imperial_units': 'SY', 'metric_units': 'M2', 'quantity_definition': 'Area of paving'},
    {
        'code': 'G206003',
    ...
    {'code': 'G206004', 'category': 'NAVIGATION AIDS', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'G206005', 'category': 'AIRFIELD MARKINGS', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {
        'code': 'G30',
    ...
    {'code': 'G305004', 'category': 'WELLS FOR COOLING', 'imperial_units': 'EA', 'metric_units': 'EA', 'quantity_definition': 'Each well'},
    {
        'code': 'G305005',
        'category': 'PUMPING STATIONS',
        'imperial_units': 'EA',
    ...
    {'code': 'G306090', 'category': 'OTHER FUEL DISTRIBUTION', 'definition': 'Fuel not described by the assembly categories listed above.'},
    {
        'code': 'G3090',
    ...
    {'code': 'G401011', 'category': 'EQUIPMENT REQUIREMENTS FOR COASTAL AND HIGH HUMIDITY AREAS'},
    {
        'code': 'G401090',
    ...
    {'code': 'G9010', 'category': 'SERVICE AND PEDESTRIAN TUNNELS', 'definition': 'This assembly includes service and pedestrian tunnels.'},
    {
        'code': 'G901001',
    ...
    {'code': 'H101002', 'category': 'PILE CAPS'},
    {'code': 'H101003', 'category': 'QUAYS'},
    {'code': 'H101004', 'category': 'RELIEVING PLATFORMS'},
    {'code': 'H101005', 'category': 'REVETMENTS'},
    {'code': 'H101006', 'category': 'SEAWALLS'},
    {'code': 'H101007', 'category': 'BOAT RAMPS'},
    {'code': 'H101008', 'category': 'CUT-OFF WALLS'},
    {'code': 'H101009', 'category': 'FIREWALLS AND HANGING PANELS'},
    {'code': 'H101090', 'category': 'OTHER SUBSTRUCTURE COMPONENTS'},
    {
        'code': 'H1020',
        'category': 'SUPERSTRUCTURE',
    ...
    {'code': 'H102001', 'category': 'BEAMS AND GIRDERS'},
    {'code': 'H102002', 'category': 'COLUMNS'},
    {'code': 'H102003', 'category': 'UTILITY ENCLOSURES'},
    {'code': 'H102090', 'category': 'OTHER SUPERSTRUCTURE ELEMENTS'},
    {
        'code': 'H1030',
        'category': 'DECK',
    ...
    {'code': 'H103001', 'category': 'DECK'},
    {'code': 'H103002', 'category': 'ON-GRADE SLAB'},
    {'code': 'H103003', 'category': 'DECK OVERLAY'},
    {'code': 'H103004', 'category': 'CURBS AND BULLRAILS'},
    {'code': 'H103005', 'category': 'MOORING FOUNDATIONS'},
    {'code': 'H103006', 'category': 'HIGH MAST LIGHTING FOUNDATIONS'},
    {'code': 'H103007', 'category': 'UTILITY MOUNDS'},
    {'code': 'H103008', 'category': 'EXPANSION JOINTS'},
    {'code': 'H103009', 'category': 'GUARD POSTS AND RAILING'},
    {'code': 'H103010', 'category': 'PAINT STRIPING'},
    {'code': 'H103090', 'category': 'OTHER DECK COMPONENTS'},
    {
        'code': 'H1040',
    ...
    {'code': 'H104001', 'category': 'PRIMARY FENDER SYSTEM'},
    {'code': 'H104002', 'category': 'SECONDARY FENDER SYSTEM'},
    {'code': 'H104003', 'category': 'CORNER FENDER SYSTEM'},
    {'code': 'H104004', 'category': 'DOLPHINS'},
    {'code': 'H104005', 'category': 'MOORING HARDWARE'},
    {'code': 'H104090', 'category': 'OTHER MOORING AND BERTHING COMPONENTS'},
    {
        'code': 'H1050',
    ...
    {'code': 'H20', 'category': 'GRAVING DRYDOCKS', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {
        'code': 'H30',
    ...
    {'code': 'H301001', 'category': 'WAVE PROTECTION ARMORS'},
    {'code': 'H301002', 'category': 'BREAKWATERS'},
    {
        'code': 'H3020',
    ...
    {'code': 'H302001', 'category': 'ROCK REVETMENTS'},
    {'code': 'H302002', 'category': 'GRANULAR FILL REVETMENTS'},
    {'code': 'H302003', 'category': 'COMBINED ROCK AND GRANULAR FILL REVETMENTS'},
    {
        'code': 'H40',
    ...
    {'code': 'H4010', 'category': 'DREDGING'},
    {'code': 'H4020', 'category': 'DREDGING DISPOSAL'},
    {'code': 'H402001', 'category': 'OCEAN DISPOSAL'},
    {'code': 'H402002', 'category': 'NEW CONFINED DISPOSAL FACILITIES'},
    {'code': 'H402003', 'category': 'EXISTING CONFINED DISPOSAL FACILITIES'},
    {'code': 'H4030', 'category': 'RECLAMATION'},
    {
        'code': 'H50',
    ...
    {'code': 'H5010', 'category': 'CIVIL/MECHANICAL UTILITIES'},
    {'code': 'H501001', 'category': 'POTABLE WATER'},
    {'code': 'H501002', 'category': 'SALTWATER'},
    {'code': 'H501003', 'category': 'SANITARY SEWER'},
    {'code': 'H501004', 'category': 'BILGE AND OILY WASTE'},
    {'code': 'H501005', 'category': 'STEAM'},
    {'code': 'H501006', 'category': 'COMPRESSED AIR'},
    {'code': 'H501090', 'category': 'OTHER CIVIL/MECHANICAL UTILITIES'},
    {'code': 'H501091', 'category': 'MISCELLANEOUS MATERIAL'},
    {'code': 'H5020', 'category': 'ELECTRICAL UTILITIES'},
    {'code': 'H502001', 'category': 'POWER DISTRIBUTION SYSTEM'},
    {'code': 'H502002', 'category': 'TELECOMMUNICATION SYSTEM'},
    {'code': 'H502003', 'category': 'LIGHTING SYSTEMS'},
    {'code': 'H502004', 'category': 'LIGHTNING PROTECTION SYSTEM'},
    {'code': 'H502005', 'category': 'POWER BOOMS'},
    {'code': 'H502090', 'category': 'OTHER ELECTRICAL UTILITIES'},
    {'code': 'H5030', 'category': 'WATERFRONT FIRE PROTECTION'},
    {'code': 'H503001', 'category': 'FIRE PROTECTION WATER DISTRIBUTION SYSTEM'},
    {'code': 'H503002', 'category': 'FIRE ALARM'},
    {'code': 'H60', 'category': 'WATERFRONT DEMOLITION', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'H6010', 'category': 'IN OR OVER-WATER DEMOLITION'},
    {'code': 'H6020', 'category': 'NON IN OR OVER-WATER DEMOLITION'},
    {'code': 'H6030', 'category': 'HAZARDOUS COMPONENTS ABATEMENT'},
    {'code': 'H70', 'category': 'WATERFRONT ATFP', 'imperial_units': 'LS', 'metric_units': 'LS'},
    {'code': 'H7010', 'category': 'WATERSIDE ATFP'},
    {'code': 'H7020', 'category': 'LANDSIDE ATFP'},
    {
        'code': 'Z',
        'category': 'GENERAL',
