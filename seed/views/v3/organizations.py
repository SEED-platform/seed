...
def _dict_org(request, organizations):
    ...
    for o in organizations:
        ...
        org = {
            ...
            "unit_options": {
                "area_options": o.MEASUREMENT_CHOICES_AREA,
                "eui_options": o.MEASUREMENT_CHOICES_EUI,
                "ghg_options": o.MEASUREMENT_CHOICES_GHG,
                "ghgi_options": o.MEASUREMENT_CHOICES_GHG_INTENSITY,
                "wui_options": o.MEASUREMENT_CHOICES_WUI,
                "water_use_options": o.MEASUREMENT_CHOICES_WATER_USE,
            },
