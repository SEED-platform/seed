    ...
    def properties(self, request, pk):
        ...
        show_columns = [
            ...
            for c in [
                ...
                fpr.facilities_plan.gross_floor_area_column,
                fpr.facilities_plan.building_category_column,
                fpr.facilities_plan.electric_eui_column,
                fpr.facilities_plan.gas_eui_column,
                fpr.facilities_plan.steam_eui_column,
