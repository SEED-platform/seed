...
schema = {
    ...
    u'Adjusted for Specific Year Current Water/Wastewater Site Energy Use Intensity (EUI)': u'float',
    u'Adjusted for Specific Year Current Water/Wastewater Source Energy Use Intensity (EUI)': u'float',
    u'Administrator Email Address': u'string',
    u'Administrator Name': u'string',
    ...
    u'Alternative Water Generated On-Site Indoor Derivation Method': u'string',
    u'Alternative Water Generated On-Site Indoor Outdoor Other Derivation Method': u'string',
    u'Alternative Water Generated On-Site Indoor Outdoor Other Resource Use': u'float',
    u'Alternative Water Generated On-Site Indoor Outdoor Other Water Cost': u'float',
    u'Alternative Water Generated On-Site Indoor Resource Use': u'float',
    u'Alternative Water Generated On-Site Indoor Water Cost': u'float',
    u'Alternative Water Generated On-Site Indoor Water Cost Intensity': u'float',
    u'Alternative Water Generated On-Site Indoor Water Intensity': u'float',
    u'Alternative Water Generated On-Site Outdoor Derivation Method': u'string',
    u'Alternative Water Generated On-Site Outdoor Resource Use': u'float',
    u'Alternative Water Generated On-Site Outdoor Water Cost': u'float',
    ...
    u'Arcade or Casino Without Lodging Design Files Gross Floor Area': u'float',
    u'Arch2030 Baseline': u'float',
    u'Aspect Ratio': u'float',
    u'Assessment Date of Compliance': u'string',
    u'Assessment Program': u'string',
    u'Assessment Target Date of Compliance': u'date',
    ...
    u'Azimuth': u'float',
    u'BEDES field name for PM-Mapping.json': u'data type',
    ...
    u'Baseline Status Timestamp': u'date',
    ...
    u'Biomass Greenhouse Gas (GHG) Emissions': u'float',
    u'Biomass Greenhouse Gas (GHG) Emissions Intensity': u'float',
    u'Biomass Water/Wastewater Greenhouse Gas (GHG) Emissions Intensity ': u'float',
    ...
    u'Building Federal Real Property Identifier': u'float',
    ...
    u'Campus Federal Real Property Identifier': u'string',
    u'Capacity': u'float',
    ...
    u'Coal (Anthracite) kBtu Resource Use': u'float',
    u'Coal (Bituminous) Resource Cost': u'float',
    u'Coal (Bituminous) kBtu Resource Use': u'float',
    u'Coal (anthracite) Cost ($)': u'float',
    u'Coal (anthracite) Derivation Method': u'string',
    u'Coal (anthracite) kBtu Design Target Resource Use': u'float',
    u'Coal (bituminous) Cost ($)': u'float',
    u'Coal (bituminous) Derivation Method': u'string',
    u'Coal (bituminous) kBtu Design Target Resource Use': u'float',
    u'Coal - Anthracite Use (kBtu)': u'float',
    u'Coal - Bituminous Use (kBtu)': u'float',
    u'Coefficient of Performance': u'float',
    u'Coke Cost ($)': u'float',
    u'Coke Derivation Method': u'string',
    u'Coke Resource Cost': u'float',
    u'Coke Use (kBtu)': u'float',
    u'Coke kBtu Design Target Resource Use': u'float',
    u'Coke kBtu Resource Use': u'float',
    ...
    u'Company Name': u'string',
    u'Complete Resource': u'string',
    u'Complete Water Indoor Gallons Resource Intensity': u'float',
    u'Complete Water Indoor Resource Cost': u'float',
    u'Complete Water Indoor Resource Cost Intensity': u'float',
    u'Complete Water Indoor kgal Resource Use': u'float',
    u'Complete Water Outdoor Resource Cost': u'float',
    u'Complete Water Outdoor kgal Resource Use': u'float',
    u'Complete Water Total Resource Cost': u'float',
    u'Complete Water kgal Resource Use': u'float',
    u'Componen Multifamily Apartment Units Number of Units': u'float',
    u'Component  Public Assembly Business Average Weekly Hours': u'float',
    u'Component  Public Assembly Workers on Main Shift Quantity': u'float',
    u'Component Arcade or Casino Without Lodging Business Average Weekly Hours': u'float',
    u'Component Arcade or Casino Without Lodging Computer Quantity': u'float',
    u'Component Arcade or Casino Without Lodging Gross Floor Area': u'float',
    u'Component Arcade or Casino Without Lodging Workers on Main Shift Quantity': u'float',
    u'Component Bank Business Average Weekly Hours': u'float',
    u'Component Bank Computer Quantity': u'float',
    u'Component Bank Cooled Percentage of Total Area': u'float',
    u'Component Bank Gross Floor Area': u'float',
    u'Component Bank Heated Percentage of Total Area': u'float',
    u'Component Bank Workers on Main Shift Quantity': u'float',
    u'Component Beauty and Health Services Business Average Weekly Hours': u'float',
    u'Component Beauty and Health Services Computer Quantity': u'float',
    u'Component Beauty and Health Services Gross Floor Area': u'float',
    u'Component Beauty and Health Services Workers on Main Shift Quantity': u'float',
    u'Component Convenience Store Business Average Weekly Hours': u'float',
    u'Component Convenience Store Cash Register Quantity': u'float',
    u'Component Convenience Store Computer Quantity': u'float',
    u'Component Convenience Store Cooled Percentage of Total Area': u'float',
    u'Component Convenience Store Gross Floor Area': u'float',
    u'Component Convenience Store Heated Percentage of Total Area': u'float',
    u'Component Convenience Store Kitchen': u'string',
    u'Component Convenience Store Refrigerated Storage Net Floor Area': u'float',
    u'Component Convenience Store Refrigeration Length': u'float',
    u'Component Convenience Store Refrigeration Quantity': u'float',
    u'Component Convenience Store Walk-in Refrigeration Quantity': u'float',
    u'Component Convenience Store Workers on Main Shift Quantity': u'float',
    u'Component Convention Center Business Average Weekly Hours': u'float',
    u'Component Convention Center Computer Quantity': u'float',
    u'Component Convention Center Gross Floor Area': u'float',
    u'Component Convention Center Workers on Main Shift Quantity': u'float',
    u'Component Correctional Facility Business Average Weekly Hours': u'float',
    u'Component Correctional Facility Computer Quantity': u'float',
    u'Component Correctional Facility Gross Floor Area': u'float',
    u'Component Correctional Facility Workers on Main Shift Quantity': u'float',
    u'Component Courthouse Business Average Weekly Hours': u'float',
    u'Component Courthouse Computer Quantity': u'float',
    u'Component Courthouse Cooled Percentage of Total Area': u'float',
    u'Component Courthouse Gross Floor Area': u'float',
    u'Component Courthouse Heated Percentage of Total Area': u'float',
    u'Component Courthouse Workers on Main Shift Quantity': u'float',
    u'Component Cultural Entertainment Business Average Weekly Hours': u'float',
    u'Component Cultural Entertainment Computer Quantity': u'float',
    u'Component Cultural Entertainment Gross Floor Area': u'float',
    u'Component Cultural Entertainment Workers on Main Shift Quantity': u'float',
    u'Component Data Center Cooling Equipment Redundancy': u'string',
    u'Component Data Center Gross Floor Area': u'float',
    u'Component Data Center IT Energy Configuration for Data Center': u'string',
    u'Component Data Center UPS Sytem Redundancy': u'string',
    u'Component Drinking Water Treatment and Distribution Daily Draw Mgal/d Consumption Rate': u'float',
    u'Component Drinking Water Treatment and Distribution Gross Floor Area': u'float',
    u'Component Dry Good Retail Business Average Weekly Hours': u'float',
    u'Component Dry Good Retail Computer Quantity': u'float',
    u'Component Dry Good Retail Gross Floor Area': u'float',
    u'Component Dry Good Retail Heated Percentage of Total Area': u'string',
    u'Component Dry Good Retail Refrigeration Length': u'float',
    u'Component Dry Good Retail Workers on Main Shift Quantity': u'float',
    u'Component Dry Goods Retail Business Average Weekly Hours': u'float',
    u'Component Dry Goods Retail Cash Register Quantity': u'float',
    u'Component Dry Goods Retail Commercial Refrigeration Quantity': u'float',
    u'Component Dry Goods Retail Computer Quantity': u'float',
    u'Component Dry Goods Retail Cooled Percentage of Total Area': u'string',
    u'Component Dry Goods Retail Gross Floor Area': u'float',
    u'Component Dry Goods Retail Kitchen': u'string',
    u'Component Dry Goods Retail Public Entrance': u'string',
    u'Component Dry Goods Retail Refrigerated Storage Net Floor Area': u'float',
    u'Component Dry Goods Retail Refrigeration Walk-in Quantity': u'float',
    u'Component Dry Goods Retail Workers on Main Shift Quantity': u'float',
    u'Component Education Business Average Weekly Hours': u'float',
    u'Component Education Business Schedule Day Weekend': u'string',
    u'Component Education Capacity Quantity': u'float',
    u'Component Education Computer Quantity': u'float',
    u'Component Education Cooled Percentage of Total Area': u'string',
    u'Component Education Gross Floor Area': u'float',
    u'Component Education Heated Percentage of Total Area': u'string',
    u'Component Education Refrigeration Walk-in Quantity': u'float',
    u'Component Education School District Code': u'string',
    u'Component Education Workers on Main Shift Quantity': u'float',
    u'Component Enclosed Mall Business Average Weekly Hours': u'float',
    u'Component Enclosed Mall Computer Quantity': u'float',
    u'Component Enclosed Mall Gross Floor Area': u'float',
    u'Component Enclosed Mall Workers on Main Shift Quantity': u'float',
    u'Component Enclosed Stadium Computer Quantity': u'float',
    u'Component Enclosed Stadium Cooled Percentage of Total Area': u'string',
    u'Component Enclosed Stadium Enclosed Floor Area': u'float',
    u'Component Enclosed Stadium Gross Floor Area': u'float',
    u'Component Enclosed Stadium Heated Percentage of Total Area': u'string',
    u'Component Enclosed Stadium Ice Performance': u'float',
    u'Component Enclosed Stadium Non-sporting Event Operation Events per Year': u'float',
    u'Component Enclosed Stadium Other Operation Events': u'float',
    u'Component Enclosed Stadium Refrigeration Walk-in Quantity': u'float',
    u'Component Enclosed Stadium Signage Display Size ft2 Capacity': u'float',
    u'Component Enclosed Stadium Sporting Event Operation Events per Year': u'float',
    u'Component Energy Generation Plant Business Average Weekly Hours': u'float',
    u'Component Energy Generation Plant Computer Quantity': u'float',
    u'Component Energy Generation Plant Gross Floor Area': u'float',
    u'Component Energy Generation Plant Workers on Main Shift Quantity': u'float',
    u'Component Fast Food Service Business Average Weekly Hours': u'float',
    u'Component Fast Food Service Computer Quantity': u'float',
    u'Component Fast Food Service Gross Floor Area': u'float',
    u'Component Fast Food Service Workers on Main Shift Quantity': u'float',
    u'Component Fitness Center Business Average Weekly Hours': u'float',
    u'Component Fitness Center Computer Quantity': u'float',
    u'Component Fitness Center Gross Floor Area': u'float',
    u'Component Fitness Center Workers on Main Shift Quantity': u'float',
    u'Component Food Sales Business Average Weekly Hours': u'float',
    u'Component Food Sales Cash Register Quantity': u'float',
    u'Component Food Sales Computer Quantity': u'float',
    u'Component Food Sales Cooled Percentage of Total Area': u'float',
    u'Component Food Sales Gross Floor Area': u'float',
    u'Component Food Sales Heated Percentage of Total Area': u'float',
    u'Component Food Sales Kitchen': u'float',
    u'Component Food Sales Refrigerated Storage Net Floor Area': u'float',
    u'Component Food Sales Refrigeration Length': u'float',
    u'Component Food Sales Walk-in Refrigeration Quantity': u'float',
    u'Component Food Sales Workers on Main Shift Quantity': u'float',
    u'Component Food Salese Refrigeration Quantity': u'float',
    u'Component Food Service Business Average Weekly Hours': u'float',
    u'Component Food Service Computer Quantity': u'float',
    u'Component Food Service Gross Floor Area': u'float',
    u'Component Food Service Workers on Main Shift Quantity': u'float',
    u'Component Full Food Service Business Average Weekly Hours': u'float',
    u'Component Full Food Service Computer Quantity': u'float',
    u'Component Full Food Service Gross Floor Area': u'float',
    u'Component Full Food Service Workers on Main Shift Quantity': u'float',
    u'Component Gas Station Business Average Weekly Hours': u'float',
    u'Component Gas Station Cash Register Quantity': u'float',
    u'Component Gas Station Computer Quantity': u'float',
    u'Component Gas Station Cooled Percentage of Total Area': u'float',
    u'Component Gas Station Gross Floor Area': u'float',
    u'Component Gas Station Heated Percentage of Total Area': u'float',
    u'Component Gas Station Kitchen': u'string',
    u'Component Gas Station Refrigerated Storage Net Floor Area': u'float',
    u'Component Gas Station Refrigeration Length': u'float',
    u'Component Gas Station Refrigeration Quantity': u'float',
    u'Component Gas Station Walk-in Refrigeration Length': u'float',
    u'Component Gas Station Workers on Main Shift Quantity': u'float',
    u'Component Grocery Store Business Average Weekly Hours': u'float',
    u'Component Grocery Store Cash Register Quantity': u'float',
    u'Component Grocery Store Commercial Refrigeration Quantity': u'float',
    u'Component Grocery Store Computer Quantity': u'float',
    u'Component Grocery Store Cooled Percentage of Total Area': u'string',
    u'Component Grocery Store Gross Floor Area': u'float',
    u'Component Grocery Store Heated Percentage of Total Area': u'string',
    u'Component Grocery Store Refrigerated Storage Net Floor Area': u'float',
    u'Component Grocery Store Refrigeration Length': u'float',
    u'Component Grocery Store Stadium Refrigeration Walk-in Quantity': u'float',
    u'Component Grocery Store Workers on Main Shift Quantity': u'float',
    u'Component Healthcare Business Average Weekly Hours': u'float',
    u'Component Healthcare Computer Quantity': u'float',
    u'Component Healthcare Gross Floor Area': u'float',
    u'Component Healthcare Workers on Main Shift Quantity': u'float',
    u'Component Higher Education Business Average Weekly Hours': u'float',
    u'Component Higher Education Computer Quantity': u'float',
    u'Component Higher Education Custom Grant Funding Level': u'float',
    u'Component Higher Education Gross Floor Area': u'float',
    u'Component Higher Education Registered Students Quantity': u'float',
    u'Component Higher Education Workers on Main Shift Quantity': u'float',
    u'Component Hypermarket Business Average Weekly Hours': u'float',
    u'Component Hypermarket Cash Register Quantity': u'float',
    u'Component Hypermarket Commercial Refrigeration Quantity': u'float',
    u'Component Hypermarket Computer Quantity': u'float',
    u'Component Hypermarket Cooled Percentage of Total Area': u'string',
    u'Component Hypermarket Gross Floor Area': u'float',
    u'Component Hypermarket Heated Percentage of Total Area': u'string',
    u'Component Hypermarket Kitchen': u'string',
    u'Component Hypermarket Public Entrance Exterior': u'string',
    u'Component Hypermarket Refrigerated Storage Net Floor Area': u'float',
    u'Component Hypermarket Refrigeration Length': u'float',
    u'Component Hypermarket Stadium Refrigeration Walk-in Quantity': u'float',
    u'Component Hypermarket Workers on Main Shift Quantity': u'float',
    u'Component Ice Rink Business Average Weekly Hours': u'float',
    u'Component Ice Rink Computer Quantity': u'float',
    u'Component Ice Rink Gross Floor Area': u'float',
    u'Component Ice Rink Workers on Main Shift Quantity': u'float',
    u'Component Indoor Sport Business Average Weekly Hours': u'float',
    u'Component Indoor Sport Computer Quantity': u'float',
    u'Component Indoor Sport Gross Floor Area': u'float',
    u'Component Indoor Sport Workers on Main Shift Quantity': u'float',
    u'Component Industrial Manufacturing Business Average Weekly Hours': u'float',
    u'Component Industrial Manufacturing Computer Quantity': u'float',
    u'Component Industrial Manufacturing Gross Floor Area': u'float',
    u'Component Industrial Manufacturing Workers on Main Shift Quantity': u'float',
    u'Component Inpatient Hospital Cooled Percentage of Total Area': u'string',
    u'Component Inpatient Hospital Full Time Equivalent (FTE) Workers Quantity': u'float',
    u'Component Inpatient Hospital Gross Floor Area': u'float',
    u'Component Inpatient Hospital Heated Percentage of Total Area': u'string',
    u'Component Inpatient Hospital Licensed Beds Quantity': u'float',
    u'Component Inpatient Hospital Medical Equipment Quantity': u'float',
    u'Component Inpatient Hospital Ownership': u'string',
    u'Component Inpatient Hospital Staffed Beds Quantity': u'float',
    u'Component Inpatient Hospital Workers on Main Shift Quantity': u'float',
    u'Component Institutional Lodging Cooled Percentage of Total Area': u'float',
    u'Component Institutional Lodging Gross Floor Area': u'float',
    u'Component Institutional Lodging Guest Cooled Percentage of Total Area': u'string',
    u'Component Institutional Lodging Guest Rooms Number of Units': u'float',
    u'Component Institutional Lodging Guest rooms Quantity': u'float',
    u'Component Institutional Lodging Heated Percentage of Total Area': u'float',
    u'Component Laboratory Business Average Weekly Hours': u'float',
    u'Component Laboratory Computer Quantity': u'float',
    u'Component Laboratory Gross Floor Area': u'float',
    u'Component Laboratory Workers on Main Shift Quantity': u'float',
    u'Component Lodging Business Average Weekly Hours': u'float',
    u'Component Lodging Computer Quantity': u'float',
    u'Component Lodging Gross Floor Area': u'float',
    u'Component Lodging Workers on Main Shift Quantity': u'float',
    u'Component Lodging with Extended Amenities Commercial Refrigeration Quantity': u'float',
    u'Component Lodging with Extended Amenities Cooled Percentage of Total Area': u'string',
    u'Component Lodging with Extended Amenities Gross Floor Area': u'float',
    u'Component Lodging with Extended Amenities Guest Rooms Number of Units': u'float',
    u'Component Lodging with Extended Amenities Heated Percentage of Total Area': u'string',
    u'Component Lodging with Extended Amenities Laundry Tons Annual  Interval Reading': u'float',
    u'Component Lodging with Extended Amenities Meal served Operation Events per Year': u'float',
    u'Component Lodging with Extended Amenities Workers on Main Shift Quantity': u'float',
    u'Component Mall Business Average Weekly Hours': u'float',
    u'Component Mall Computer Quantity': u'float',
    u'Component Mall Gross Floor Area': u'float',
    u'Component Mall Workers on Main Shift Quantity': u'float',
    u'Component Multifamily Apartment Units Quantity': u'float',
    u'Component Multifamily Bedrooms Quantity': u'float',
    u'Component Multifamily Common Area Dishwasher Quantity ': u'float',
    u'Component Multifamily Common Area Laundry Quantity': u'float',
    u'Component Multifamily Cooled Percentage of Total Area': u'string',
    u'Component Multifamily Dishwasher Quantity': u'float',
    u'Component Multifamily Government Subsidized Community': u'string',
    u'Component Multifamily Gross Floor Area': u'float',
    u'Component Multifamily Heated Percentage of Total Area': u'string',
    u'Component Multifamily Laundry Hookups in All Units Quantity': u'float',
    u'Component Multifamily Laundry Hookups in Common Area(s) Quantity': u'float',
    u'Component Multifamily Lodging Area Dishwasher Quantity': u'float',
    u'Component Multifamily Lodging Area Laundry Quantity': u'float',
    u'Component Multifamily Number of Bedrooms Density (Number per 1,000 ft2)': u'float',
    u'Component Multifamily Occupant Type': u'string',
    u'Component Multifamily Percentage of Common Space': u'float',
    u'Component Multifamily Service Hot Water Input Resource': u'string',
    u'Component Non-Enclosed Stadium Computer Quantity': u'float',
    u'Component Non-Enclosed Stadium Cooled Percentage of Total Area': u'string',
    u'Component Non-Enclosed Stadium Enclosed Floor Area': u'float',
    u'Component Non-Enclosed Stadium Gross Floor Area': u'float',
    u'Component Non-Enclosed Stadium Heated Percentage of Total Area': u'string',
    u'Component Non-Enclosed Stadium Ice Performance': u'float',
    u'Component Non-Enclosed Stadium Non-sporting Event Operation Events per Year': u'float',
    u'Component Non-Enclosed Stadium Other Operation Events': u'float',
    u'Component Non-Enclosed Stadium Refrigeration Walk-in Quantity': u'float',
    u'Component Non-Enclosed Stadium Signage Display Size ft2 Capacity': u'float',
    u'Component Non-Enclosed Stadium Sporting Event Operation Events per Year': u'float',
    u'Component Non-refrigerated Warehouse Business Average Weekly Hours': u'float',
    u'Component Non-refrigerated Warehouse Cooled Percentage of Total Area': u'string',
    u'Component Non-refrigerated Warehouse Gross Floor Area': u'float',
    u'Component Non-refrigerated Warehouse Heated Percentage of Total Area': u'string',
    u'Component Non-refrigerated Warehouse Refrigeration Walk-in Quantity': u'float',
    u'Component Non-refrigerated Warehouse Workers on Main Shift Quantity': u'float',
    u'Component Office Business Average Weekly Hours': u'float',
    u'Component Office Computer Quantity': u'float',
    u'Component Office Cooled Percentage of Total Area': u'string',
    u'Component Office Gross Floor Area': u'float',
    u'Component Office Heated Percentage of Total Area': u'string',
    u'Component Office Workers on Main Shift Quantity': u'float',
    u'Component Other Business Average Weekly Hours': u'float',
    u'Component Other Computer Quantity': u'float',
    u'Component Other Gross Floor Area': u'float',
    u'Component Other Workers on Main Shift Quantity': u'float',
    u'Component Outpatient Non-diagnostic Business Average Weekly Hours': u'float',
    u'Component Outpatient Non-diagnostic Computer Quantity': u'float',
    u'Component Outpatient Non-diagnostic Cooled Percentage of Total Area': u'string',
    u'Component Outpatient Non-diagnostic Gross Floor Area': u'float',
    u'Component Outpatient Non-diagnostic Heated Percentage of Total Area': u'string',
    u'Component Outpatient Non-diagnostic Medical Equipment Quantity': u'float',
    u'Component Outpatient Non-diagnostic Workers on Main Shift Quantity': u'float',
    u'Component Outpatient Rehabilitation Business Average Weekly Hours': u'float',
    u'Component Outpatient Rehabilitation Computer Quantity': u'float',
    u'Component Outpatient Rehabilitation Gross Floor Area': u'float',
    u'Component Outpatient Rehabilitation Workers on Main Shift Quantity': u'float',
    u'Component Outpatient Surgical Business Average Weekly Hours': u'float',
    u'Component Outpatient Surgical Computer Quantity': u'float',
    u'Component Outpatient Surgical Gross Floor Area': u'float',
    u'Component Outpatient Surgical Workers on Main Shift Quantity': u'float',
    u'Component Parking Enclosed Floor Area': u'float',
    u'Component Parking Floor Area': u'float',
    u'Component Parking Non-enclosed Floor Area': u'float',
    u'Component Parking Open Floor Area': u'float',
    u'Component Postal Service Business Average Weekly Hours': u'float',
    u'Component Postal Service Computer Quantity': u'float',
    u'Component Postal Service Gross Floor Area': u'float',
    u'Component Postal Service Workers on Main Shift Quantity': u'float',
    u'Component Preschool or Daycare Business Average Weekly Hours': u'float',
    u'Component Preschool or Daycare Computer Quantity': u'float',
    u'Component Preschool or Daycare Gross Floor Area': u'float',
    u'Component Preschool or Daycare Workers on Main Shift Quantity': u'float',
    u'Component Public Assembly Computer Quantity': u'float',
    u'Component Public Assembly Gross Floor Area': u'float',
    u'Component Public Safety Station Business Average Weekly Hours': u'float',
    u'Component Public Safety Station Computer Quantity': u'float',
    u'Component Public Safety Station Gross Floor Area': u'float',
    u'Component Public Safety Station Workers on Main Shift Quantity': u'float',
    u'Component Recreation Business Average Weekly Hours': u'float',
    u'Component Recreation Computer Quantity': u'float',
    u'Component Recreation Gross Floor Area': u'float',
    u'Component Recreation Workers on Main Shift Quantity': u'float',
    u'Component Refrigerated Warehouse Business Average Weekly Hours': u'float',
    u'Component Refrigerated Warehouse Gross Floor Area': u'float',
    u'Component Refrigerated Warehouse Workers on Main Shift Quantity': u'float',
    u'Component Religious Congregation Business Average Weekly Hours': u'float',
    u'Component Religious Congregation Commercial Refrigeration Quantity': u'float',
    u'Component Religious Congregation Computer Quantity': u'float',
    u'Component Religious Congregation Gross Floor Area': u'float',
    u'Component Religious Congregation Weekday Quantity': u'float',
    u'Component Religious congregation Capacity Quantity': u'float',
    u'Component Repair Services Business Average Weekly Hours': u'float',
    u'Component Repair Services Computer Quantity': u'float',
    u'Component Repair Services Gross Floor Area': u'float',
    u'Component Repair Services Workers on Main Shift Quantity': u'float',
    u'Component Secondary Education': u'string',
    u'Component Self-storage Business Average Weekly Hours': u'float',
    u'Component Self-storage Computer Quantity': u'float',
    u'Component Self-storage Gross Floor Area': u'float',
    u'Component Self-storage Workers on Main Shift Quantity': u'float',
    u'Component Service Business Average Weekly Hours': u'float',
    u'Component Service Computer Quantity': u'float',
    u'Component Service Gross Floor Area': u'float',
    u'Component Service Workers on Main Shift Quantity': u'float',
    u'Component Single Family Bedrooms Quantity': u'float',
    u'Component Single Family Gross Floor Area': u'float',
    u'Component Single family Peak Total Occupants Quantity': u'float',
    u'Component Skilled Nursing Facility Average Residents Quantity': u'float',
    u'Component Skilled Nursing Facility Capacity Quantity': u'float',
    u'Component Skilled Nursing Facility Commercial Clothes Washer Quantity': u'float',
    u'Component Skilled Nursing Facility Commercial Refrigeration Quantity': u'float',
    u'Component Skilled Nursing Facility Computer Quantity': u'float',
    u'Component Skilled Nursing Facility Cooled Percentage of Total Area': u'string',
    u'Component Skilled Nursing Facility Gross Floor Area': u'float',
    u'Component Skilled Nursing Facility Guest Rooms Quantity': u'float',
    u'Component Skilled Nursing Facility Heated Percentage of Total Area': u'string',
    u'Component Skilled Nursing Facility People Lift System Quantity': u'float',
    u'Component Skilled Nursing Facility Residential Clothes Washer Quantity': u'float',
    u'Component Skilled Nursing Facility Workers on Main Shift Quantity': u'float',
    u'Component Social Entertainment Business Average Weekly Hours': u'float',
    u'Component Social Entertainment Computer Quantity': u'float',
    u'Component Social Entertainment Gross Floor Area': u'float',
    u'Component Social Entertainment Workers on Main Shift Quantity': u'float',
    u'Component Stadium Business Average Weekly Hours': u'float',
    u'Component Stadium Computer Quantity': u'float',
    u'Component Stadium Cooled Percentage of Total Area': u'string',
    u'Component Stadium Enclosed Floor Area': u'float',
    u'Component Stadium Gross Floor Area': u'float',
    u'Component Stadium Heated Percentage of Total Area': u'string',
    u'Component Stadium Ice Performance': u'float',
    u'Component Stadium Ice performance': u'float',
    u'Component Stadium Non-sporting Event Operation Events per Year': u'float',
    u'Component Stadium Other Operation Events per Year': u'float',
    u'Component Stadium Refrigeration Walk-in Quantity': u'float',
    u'Component Stadium Signage Display Size Ft2 Capacity': u'float',
    u'Component Stadium Signage Display Size ft2 Capacity': u'float',
    u'Component Stadium Sporting Event Operation Events per Year': u'float',
    u'Component Stadium Workers on Main Shift Quantity': u'float',
    u'Component Strip Mall Business Average Weekly Hours': u'float',
    u'Component Strip Mall Computer Quantity': u'float',
    u'Component Strip Mall Gross Floor Area': u'float',
    u'Component Strip Mall Workers on Main Shift Quantity': u'float',
    u'Component Transportation Terminal Business Average Weekly Hours': u'float',
    u'Component Transportation Terminal Computer Quantity': u'float',
    u'Component Transportation Terminal Gross Floor Area': u'float',
    u'Component Transportation Terminal Workers on Main Shift Quantity': u'float',
    u'Component Utility Business Average Weekly Hours': u'float',
    u'Component Utility Computer Quantity': u'float',
    u'Component Utility Gross Floor Area': u'float',
    u'Component Utility Workers on Main Shift Quantity': u'float',
    u'Component Veterinary Business Average Weekly Hours': u'float',
    u'Component Veterinary Computer Quantity': u'float',
    u'Component Veterinary Gross Floor Area': u'float',
    u'Component Veterinary Workers on Main Shift Quantity': u'float',
    u'Component Vivarium Business Average Weekly Hours': u'float',
    u'Component Vivarium Computer Quantity': u'float',
    u'Component Vivarium Gross Floor Area': u'float',
    u'Component Vivarium Workers on Main Shift Quantity': u'float',
    u'Component Wastewater Treatment Plant Average Effluent Biological Oxygen Demand ': u'float',
    u'Component Wastewater Treatment Plant Average Influent Biological Oxygen Demand': u'float',
    u'Component Wastewater Treatment Plant Gross Floor Area': u'float',
    u'Component Wastewater Treatment Plant Nutrient Removal Proces Implemented': u'string',
    u'Component Wastewater Treatment Plant Plant Design Flow Value': u'float',
    u'Component Wastewater Treatment PlantTrickle Filtration Process Fixed Film': u'string',
    ...
    u'Convention Center Design Files Gross Floor Area': u'float',
    ...
    u'Correctional Facility Design Files Gross Floor Area': u'float',
    ...
    u'Cultural Entertainment Design Files Gross Floor Area': u'float',
    u'Current Status Timestamp': u'date',
    ...
    u'Data Center IT Equipment Input Site Energy Energy Use': u'',
    u'Data Center Power Distribution Unit (PDU) Input Energy Energy Use': u'float',
    u'Data Center Power Distribution Unit (PDU) Output Site Energy energy Use': u'float',
    u'Data Center Power Usage Effectiveness Efficiency Value': u'float',
    u'Data Center Quality Alert': u'string',
    u'Data Center Site IT kWh Energy Use': u'float',
    u'Data Center Source IT kBtu Energy Use': u'float',
    u'Data center Design Files Gross Floor Area': u'float',
    u'Data center UPS Output Site Energy Energy Use': u'float',
    u'Date Completed': u'float',
    ...
    u'Design Files ENERGY STAR Score Assessment Metric Value': u'float',
    u'Design Files Gross Floor Area': u'float',
    ...
    u'Design Target Biomass Greenhouse Gas (GHG) Emissions': u'float',
    u'Design Target Direct Greenhouse Gas (GHG) Emissions': u'float',
    u'Design Target ENERGY STAR Score': u'float',
    u'Design Target ENERGY STAR Score Assessment Metric Value': u'float',
    u'Design Target Energy Cost': u'float',
    u'Design Target Energy Cost ($)': u'float',
    u'Design Target Energy Cost Intensity': u'float',
    u'Design Target Indirect Greenhouse Gas (GHG) Emissions': u'float',
    ...
    u'Design Target Site Energy Use Intensity (EUI)': u'float',
    ...
    u'Design Target Source Energy Use Intensity (EUI)': u'float',
    u'Design Target Source National Median Percent Improvement in Performance Over a Baseline': u'float',
    u'Design Target Total GHG Emissions (MtCO2e)': u'float',
    u'Design Target Total GHG Emissions Intensity (kgCO2e/ft2)': u'float',
    u'Design Target Total Greenhouse Gas (GHG) Emissions': u'float',
    u'Design Target Total Greenhouse Gas (GHG) Emissions Intensity': u'float',
    u'Design Target Water/Wastewater Site EUI (kBtu/gpd)': u'float',
    u'Design Target Water/Wastewater Site Energy Use Intensity (EUI)': u'float',
    u'Design Target Water/Wastewater Source EUI (kBtu/gpd)': u'float',
    u'Design Target Water/Wastewater Source Energy Use Intensity (EUI)': u'float',
    ...
    u'Diesel Derivation Method': u'string',
    u'Diesel Resource Cost': u'float',
    u'Diesel kBtu Design Target Resource Use': u'float',
    u'Diesel kBtu Resource Use': u'float',
    u'Direct GHG Emissions (MtCO2e)': u'float',
    u'Direct GHG Emissions Intensity (kgCO2e/ft2)': u'float',
    u'Direct Greenhouse Gas (GHG) Emissions': u'float',
    u'Direct Greenhouse Gas (GHG) Emissions Intensity': u'float',
    u'Direct Water/Wastewater Greenhouse Gas (GHG) Emissions Intensity ': u'float',
    ...
    u'District Chilled Water Derivation Method': u'string',
    u'District Chilled Water Resource Cost': u'float',
    u'District Chilled Water Use (kBtu)': u'float',
    u'District Chilled Water kBtu Resource Use': u'float',
    u'District Host Water kBtu Resource Use': u'float',
    u'District Hot Water': u'string',
    u'District Hot Water Cost ($)': u'float',
    u'District Hot Water Derivation Method': u'string',
    u'District Hot Water Resource Cost': u'float',
    u'District Hot Water Use (kBtu)': u'float',
    u'District Hot Water kBtu Design Target Resource Use': u'float',
    u'District Steam': u'string',
    u'District Steam Cost ($)': u'float',
    u'District Steam Derivation Method': u'string',
    u'District Steam Resource Cost': u'float',
    u'District Steam Use (kBtu)': u'float',
    u'District Steam kBtu Design Target Resource Use': u'float',
    u'District Steam kBtu Resource Use': u'float',
    ...
    u'Drinking Water Treatment and Distribution Design Files Gross Floor Area': u'float',
    u'Dry Goods Retail Design Files Gross Floor Area': u'float',
    u'Dry goods Retail Derivation Method Default': u'string',
    ...
    u'ENERGY STAR Certification Assessment Application Status': u'string',
    u'ENERGY STAR Certification Assessment Eligibility': u'string',
    u'ENERGY STAR Certification Assessment Last Approval Date': u'date',
    u'ENERGY STAR Certification Assessment Next Eligible Date': u'date',
    u'ENERGY STAR Certification Assessment Profile': u'string',
    ...
    u'EPA (US Environmental Protection Agency) Greenhouse Gas (GHG) Emissions Intensity': u'float',
    ...
    u'Electricity Utility Provided Resource Cost': u'float',
    u'Electricity Utility provided Derivation Method': u'string',
    u'Electricity Weather Normalized Water/Wastewater Site Energy Use Intensity (EUI)': u'float',
    u'Electricity kBtu Utility Provided Onsite Renewable Onsite Resource Use': u'float',
    u'Electricity kBtu Utility Provided Onsite Renewable Resource Use': u'float',
    u'Electricity kBtu Utility Provided Onsite Resource Use': u'float',
    u'Electricity kBtu Utility Provided Onsite Resource Use Onsite ': u'float',
    u'Electricity kBtu Utility Provided Resource Use': u'float',
    u'Electricity kBtu Utility provided Design Target Resource Use': u'float',
    u'Electricity kWh Utility Provided Onsite Renewable ': u'float',
    u'Electricity kWh Utility Provided Onsite Renewable Onsite Resource Use': u'float',
    u'Electricity kWh Utility Provided Onsite Renewable Resource Use': u'float',
    u'Electricity kWh Utility Provided Onsite Resource Use': u'float',
    u'Electricity kWh Utility Provided Onsite Resource Use Onsite ': u'float',
    u'Electricity kWh Utility Provided Resource Use': u'float',
    u'Electricity kWh Weather Normalized Site Resource Intensity': u'float',
    u'Electricity kWh Weather Normalized Site Resource Use': u'float',
    ...
    u'Enclosed Mall Design Files Gross Floor Area': u'float',
    ...
    u'Fast Food Service Design Files Gross Floor Area': u'float',
    u'Federal Agency': u'string',
    u'Federal Agency/Department': u'string',
    u'Federal Department': u'string',
    u'Federal Government Agency Company': u'string',
    ...
    u'Financing Implementation Cost': u'float',
    u'Financing Implementation Cost Intensity': u'float',
    ...
    u'Fitness Center Design Files Gross Floor Area': u'float',
    ...
    u'Flow Derivation Method': u'string',
    ...
    u'Fuel Oil No-1 Derivation Method': u'string',
    u'Fuel Oil No-1 Resource Cost': u'float',
    u'Fuel Oil No-1 kBtu Design Target Resource Use': u'float',
    u'Fuel Oil No-1 kBtu Resource Use': u'float',
    u'Fuel Oil No-2 Derivation Method': u'string',
    u'Fuel Oil No-2 Resource Cost': u'float',
    u'Fuel Oil No-2 kBtu Design Target Resource Use': u'float',
    u'Fuel Oil No-2 kBtu Resource Use': u'float',
    u'Fuel Oil No-4 Derivation Method': u'string',
    u'Fuel Oil No-4 Resource Cost': u'float',
    u'Fuel Oil No-4 kBtu Design Target Resource Use': u'float',
    u'Fuel Oil No-4 kBtu Resource Use': u'float',
    u'Fuel Oil No-5 and No-6 Derivation Method': u'string',
    u'Fuel Oil No-5 and No-6 Resource Cost': u'float',
    u'Fuel Oil No-5 and No-6 kBtu Design Target Resource Use': u'float',
    u'Fuel Oil No-5 and No-6 kBtu Resource Use': u'float',
    u'Fuel Use Intensity': u'float',
    u'Full Food Service Design Files Gross Floor Area': u'float',
    ...
    u'Government Agency Company': u'string',
    u'Green Power (Percent of Total Electricity, including Grid Purchase and Onsite) ': u'float',
    u'Green Power - Offsite (kWh)': u'float',
    u'Green Power - Onsite (kWh)': u'float',
    u'Green Power - Onsite and Offsite (kWh)': u'float',
    u'Grocery Store Derivation Method Default': u'string',
    u'Grocery Store Design Files Gross Floor Area': u'float',
    ...
    u'Healthcare Design Files Gross Floor Area': u'float',
    ...
    u'Higher Education Design Files Gross Floor Area': u'float',
    ...
    u'Hypermarket Derivation Method Default': u'string',
    u'IT Derivation Method': u'string',
    u'IT Energy Intensity': u'float',
    u'IT Peak Power': u'float',
    u'IT Standby Power': u'float',
    u'IT System Type': u'string',
    u'Ice Rink Design Files Gross Floor Area': u'float',
    ...
    u'Indirect Greenhouse Gas (GHG) Emissions': u'float',
    u'Indirect Greenhouse Gas (GHG) Emissions Intensity': u'float',
    u'Indirect Tank Heating Source': u'string',
    u'Indirect Water/Wastewater Greenhouse Gas (GHG) Emissions Intensity ': u'float',
    ...
    u'Indoor Sport Design Files Gross Floor Area': u'float',
    ...
    u'Inpatient Hospital Derivation Method Default': u'string',
    u'Inpatient Hospital Design Files Gross Floor Area': u'float',
    ...
    u'Institutional Lodging Derivation Method Default': u'string',
    u'Institutional Lodging Design Files Gross Floor Area': u'float',
    ...
    u'Kerosene Derivation Method': u'string',
    u'Kerosene Resource Cost': u'float',
    u'Kerosene Use (kBtu)': u'float',
    u'Kerosene kBtu Design Target Resource Use': u'float',
    u'Kerosene kBtu Resource Use': u'float',
    ...
    u'Liquid Propane Derivation Method': u'string',
    u'Liquid Propane Resource Cost': u'float',
    u'Liquid Propane Use (kBtu)': u'float',
    u'Liquid Propane kBtu Design Target Resource Use': u'float',
    u'Liquid Propane kBtu Resource Use': u'float',
    ...
    u'Mall Design Files Gross Floor Area': u'float',
    ...
    u'Mechanical Repair Shop Design Files Gross Floor Area': u'float',
    ...
    u'Municipally Supplied Potable Water Indoor Derivation Method': u'string',
    u'Municipally Supplied Potable Water Indoor Outdoor Other Derivation Method': u'string',
    u'Municipally Supplied Potable Water Indoor Outdoor Other Water Cost': u'float',
    u'Municipally Supplied Potable Water Indoor Outdoor Other kgal Resource Use': u'float',
    u'Municipally Supplied Potable Water Indoor Water Cost': u'float',
    u'Municipally Supplied Potable Water Indoor Water Cost Intensity': u'float',
    u'Municipally Supplied Potable Water Indoor Water Intensity': u'float',
    u'Municipally Supplied Potable Water Indoor kgal Resource Use': u'float',
    u'Municipally Supplied Potable Water Outdoor Derivation Method': u'string',
    u'Municipally Supplied Potable Water Outdoor Water Cost': u'float',
    u'Municipally Supplied Potable Water Outdoor kgal Resource Use': u'float',
    ...
    u'Municipally Supplied Reclaimed Water Indoor Derivation Method': u'string',
    u'Municipally Supplied Reclaimed Water Indoor Outdoor Other Derivation Method': u'string',
    u'Municipally Supplied Reclaimed Water Indoor Outdoor Other Water Cost': u'float',
    u'Municipally Supplied Reclaimed Water Indoor Outdoor Other kgal Resource Use': u'float',
    u'Municipally Supplied Reclaimed Water Indoor Water Cost': u'float',
    u'Municipally Supplied Reclaimed Water Indoor Water Cost Intensity': u'float',
    u'Municipally Supplied Reclaimed Water Indoor Water Intensity': u'float',
    u'Municipally Supplied Reclaimed Water Indoor kgal Resource Use': u'float',
    u'Municipally Supplied Reclaimed Water Outdoor Derivation Method': u'string',
    u'Municipally Supplied Reclaimed Water Outdoor Water Cost': u'float',
    u'Municipally Supplied Reclaimed Water Outdoor kgal Resource Use': u'float',
    ...
    u'National Median Data center Power Usage Effectiveness Efficiency Value': u'float',
    u'National Median ENERGY STAR Score': u'float',
    u'National Median ENERGY STAR Score Assessment Metric Value': u'float',
    ...
    u'National Median Site Energy Use Intensity (EUI) ': u'float',
    ...
    u'National Median Source Energy Use Intensity (EUI) ': u'float',
    u'National Median Total GHG Emissions (MtCO2e)': u'float',
    u'National Median Total Greenhouse Gas (GHG) Emissions': u'float',
    u'National Median Water/Wastewater Site EUI (kBtu/gpd)': u'float',
    u'National Median Water/Wastewater Site Energy Use Intensity (EUI)': u'float',
    u'National Median Water/Wastewater Source EUI (kBtu/gpd)': u'float',
    u'National Median Water/Wastewater Source Energy Use Intensity (EUI)': u'float',
    u'Natural Gas': u'string',
    u'Natural Gas Cost ($)': u'float',
    u'Natural Gas Derivation Method': u'string',
    u'Natural Gas Resource Cost': u'float',
    u'Natural Gas Therms Weather Normalized Site Resource Intensity': u'float',
    u'Natural Gas Therms Weather Normalized Site Resource Use': u'float',
    u'Natural Gas Use (kBtu)': u'float',
    u'Natural Gas Use (therms)': u'float',
    u'Natural Gas Weather Normalized Water/Wastewater Site Energy Use Intensity (EUI)': u'float',
    u'Natural Gas kBtu Design Target Resource Use': u'float',
    u'Natural Gas kBtu Resource Use': u'float',
    u'Natural Gas therms Resource Use': u'float',
    u'Natural Ventilation': u'string',
    u'Natural Ventilation Method': u'string',
    u'Natural Ventilation Rate': u'float',
    u'Net CO2e Greenhouse Gas (GHG) Emissions': u'float',
    ...
    u'Non-refrigerated Warehouse Derivation Method Default': u'string',
    u'Non-refrigerated Warehouse Design Files Gross Floor Area': u'float',
    ...
    u'Offisite Renewable Avoided Emissions': u'float',
    u'Offsite Green Power': u'float',
    u'On-Site Generation Type': u'string',
    u'On-site Renewable Electricity': u'float',
    u'Onisite Renewable Avoided Emissions': u'float',
    u'Onsite Green Power': u'float',
    u'Onsite Renewable Avoided Emissions': u'float',
    u'Onsite Renewable Offsite Renewable Avoided Emissions': u'float',
    u'Onsite Renewable System Electricity Exported': u'float',
    u'Onsite and Offsite Green Power': u'float',
    ...
    u'Other Derivation Method': u'string',
    ...
    u'Other kBtu Design Target Resource Use': u'float',
    u'Other kBtu Resource Use': u'float',
    u'Outdoor Water Cost (All Water Sources) ($)': u'float',
    u'Outdoor Water Use (All Water Sources) (kgal)': u'float',
    u'Outpatient Non-diagnostic Derivation Method Default': u'string',
    u'Outpatient Non-diagnostic Design Files Gross Floor Area': u'float',
    u'Outpatient Rehabilitation Design Files Gross Floor Area': u'float',
    ...
    u'Outpatient Surgical Design Files Gross Floor Area': u'float',
    ...
    u'People with Access to Property': u'float',
    ...
    u'Percent Better than National Median Water/Wastewater Site Energy Use Intensity (EUI)': u'float',
    u'Percent Better than National Median Water/Wastewater Source EUI': u'float',
    u'Percent Better than National Median Water/Wastewater Source Energy Use Intensity (EUI)': u'float',
    ...
    u'Pool Design Files Gross Floor Area': u'float',
    u'Pool Hours Uncovered': u'float',
    u'Pool Location': u'string',
    u'Pool Pool Size Category': u'string',
    ...
    u'Portfolio Manager Generation Date': u'date',
    u'Portfolio Manager Parent Property ID': u'string',
    u'Portfolio Manager Parent Property Name': u'string',
    u'Portfolio Manager Property ID': u'string',
    u'Portfolio Manager Release Date': u'date',
    u'Portfolio Manager Year Ending': u'date',
    u'Postal Service Design Files Gross Floor Area': u'float',
    u'Potable': u'string',
    u'Potable Water Savings': u'float',
    u'Power Distribution Unit (PDU) Input Energy Derivation Method': u'string',
    u'Power Distribution Unit (PDU) Output Energy Derivation Method': u'string',
    u'Power Plant': u'string',
    u'Power Usage Effectiveness (PUE) Design files Efficiency Value': u'float',
    ...
    u'Premises Street Additional Info': u'string',
    ...
    u'Preschool or Daycare Design Files Gross Floor Area': u'float',
    ...
    u'Propane Derivation Method': u'string',
    u'Propane Resource Cost': u'float',
    u'Propane Use (kBtu)': u'float',
    u'Propane kBtu Design Target Resource Use': u'float',
    u'Propane kBtu Resource Use': u'float',
    ...
    u'Rating Last Approval Date': u'date',
    ...
    u'Refrigerated Warehouse Derivation Method Default': u'string',
    u'Refrigerated Warehouse Design Files Gross Floor Area': u'float',
    ...
    u'Religious Congregation Derivation Method Default': u'string',
    ...
    u'Self-storage Design Files Gross Floor Area': u'float',
    ...
    u'Service and Product Provider Name': u'string',
    ...
    u'Site Adjusted for Specific Year Current Energy Use': u'float',
    u'Site Adjusted for Specific Year Current Energy Use Intensity (EUI) ': u'float',
    ...
    u'Site Energy Use Intensity (EUI) ': u'float',
    u'Site Use Description': u'string',
    u'Skilled Nursing Facility Derivation Method Default': u'string',
    u'Skilled Nursing Facility Design Files Gross Floor Area': u'float',
    ...
    u'Social Entertainment Design Files Gross Floor Area': u'float',
    ...
    u'Source Adjusted for Specific Year Current Energy Use': u'float',
    u'Source Adjusted for Specific Year Current Energy Use Intensity (EUI) ': u'float',
    ...
    u'Source Energy Use Intensity (EUI) ': u'float',
    ...
    u'Stadium Design Files Gross Floor Area': u'float',
    ...
    u'Strip Mall Design Files Gross Floor Area': u'float',
    u'Sub-component Beauty and Health Services Gross Floor Area': u'float',
    u'Sub-component Commercial Kitchen': u'string',
    u'Sub-component Commercial Laundry Area': u'string',
    u'Sub-component Commercial Laundry Load Type': u'string',
    u'Sub-component Computer Lab': u'string',
    u'Sub-component Fitness Center Gross Floor Area': u'float',
    u'Sub-component Institutional Food Service': u'string',
    u'Sub-component Medical Laboratory': u'string',
    u'Sub-component Outpatient Surgical Gross Floor Area': u'float',
    u'Sub-component Tertiery Care': u'string',
    ...
    u'Target Site Energy Use Intensity (EUI)': u'float',
    u'Target Source EUI (kBtu/ft2)': u'float',
    u'Target Source Energy Use': u'float',
    u'Target Source Energy Use (kBtu)': u'float',
    u'Target Source Energy Use Intensity (EUI)': u'float',
    u'Target Total GHG Emissions (MtCO2e)': u'float',
    u'Target Total GHG Emissions Intensity (kgCO2e/ft2)': u'float',
    u'Target Total Greenhouse Gas (GHG) Emissions': u'float',
    u'Target Total Greenhouse Gas (GHG) Emissions Intensity': u'float',
    u'Target Water/Wastewater Site EUI (kBtu/gpd)': u'float',
    u'Target Water/Wastewater Site Energy Use Intensity (EUI)': u'float',
    u'Target Water/Wastewater Source EUI (kBtu/gpd)': u'float',
    u'Target Water/Wastewater Source Energy Use Intensity (EUI)': u'float',
    ...
    u'Total Greenhouse Gas (GHG) Emissions': u'float',
    u'Total Greenhouse Gas (GHG) Emissions Intensity': u'float',
    u'Total Heat Rejection': u'float',
    u'Total Resource and Non-resource Estimated Non-resource Cost Benefit Intensity': u'float',
    u'Total Resource and Non-resource Estimated Non-resource Cost Benefits': u'float',
    u'Total Water Cost (All Water Sources) ($)': u'float',
    u'Total Water/Wastewater Greenhouse Gas (GHG) Emissions Intensity ': u'float',
    ...
    u'UPS Output Site Energy Derivation Method': u'string',
    ...
    u'Water Indoor Derivation Method': u'string',
    u'Water Indoor Outdoor Other Derivation Method': u'string',
    u'Water Indoor Outdoor Other Resource Cost': u'float',
    u'Water Indoor Outdoor Other kgal Resource Use': u'float',
    u'Water Indoor Resource Cost': u'float',
    u'Water Indoor Resource Cost Intensity': u'float',
    u'Water Indoor Water Intensity': u'float',
    u'Water Indoor kgal Resource Use': u'float',
    u'Water Intensity': u'float',
    u'Water Metered Premises': u'string',
    u'Water Outdoor Derivation Method': u'string',
    u'Water Outdoor Resource Cost': u'float',
    u'Water Outdoor kgal Resource Use': u'float',
    u'Water Use': u'float',
    ...
    u'Weather Normalized Site Energy Use Intensity (EUI) ': u'float',
    ...
    u'Weather Normalized Source Energy Use Intensity (EUI)': u'float',
    u'Weather Normalized Water/Wastewater Site Electricity Intensity (kWh/gpd)': u'float',
    u'Weather Normalized Water/Wastewater Site Energy Use Intensity (EUI)': u'float',
    ...
    u'Weather Normalized Water/Wastewater Source Energy Use Intensity (EUI)': u'float',
    ...
    u'Wholesale Club/Supercenter - Single Store': u'string',
    ...
    u'Wood Cost ($)': u'float',
    u'Wood Derivation Method': u'string',
    u'Wood Resource Cost': u'float',
    u'Wood Use (kBtu)': u'float',
    u'Wood kBtu Design Target Resource Use': u'float',
    u'Wood kBtu Resource Use': u'float',
