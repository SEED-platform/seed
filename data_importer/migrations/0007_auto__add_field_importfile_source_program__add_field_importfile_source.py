...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportFile.source_program'
        db.add_column(u'data_importer_importfile', 'source_program',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)

        # Adding field 'ImportFile.source_program_version'
        db.add_column(u'data_importer_importfile', 'source_program_version',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportFile.source_program'
        db.delete_column(u'data_importer_importfile', 'source_program')

        # Deleting field 'ImportFile.source_program_version'
        db.delete_column(u'data_importer_importfile', 'source_program_version')
    ...
    models = {
        ...
        u'data_importer.importfile': {
            ...
            'source_program': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
            'source_program_version': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
