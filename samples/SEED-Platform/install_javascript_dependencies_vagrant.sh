...
if [ ! -f /vagrant/seed/seed/static/vendors/bower_components/fine-uploader/_build/s3.fineuploader.js ];
then
    ...
    cd /vagrant/seed/seed/static/vendors/bower_components/fine-uploader/
    npm install
    echo ""
    echo ""
    echo ""
